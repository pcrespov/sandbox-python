def zoo(
    ...
    /,  # All preceding arguments are positional-only
    ...
    *args,  # Variable positional arguments # All following arguments are keyword-only
    ...
    **kwargs,  # Variable keyword arguments
    ...
    print("pos_only_no_default:", pos_only_no_default)
    print("pos_or_kwarg_no_default:", pos_or_kwarg_no_default)
    print("pos_or_kwarg_with_default:", pos_or_kwarg_with_default)
    print("kwarg_only_no_default:", kwarg_only_no_default)
    print("kwarg_only_with_default:", kwarg_only_with_default)
    print("Additional positional arguments (*args):", args)
    print("Additional keyword arguments (**kwargs):", kwargs)


zoo(1, 2, 3, 4, 5, 6, kwarg_only_no_default="a", b="b", c="c")
