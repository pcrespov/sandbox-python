...
# https://raw.githubusercontent.com/nadirizr/json-logic-py/master/json_logic/__init__.py
...
def eval_json_logic(tests, data=None):
    ...
    # Recursion!
    values = [eval_json_logic(val, data) for val in values]
