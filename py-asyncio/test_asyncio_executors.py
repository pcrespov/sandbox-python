...
_to_async = to_async_in_loop  # WARNING: cannot use this the *_pool without creating a pool outside!
...
# -------------------------------('fun_cpu_bound', 'to_async_in_loop')--------------------------------
# len(data)=50
# - async_run partition_size=1
# 19.356881856918335
# - sync_run partition_size=1
# 20.382945775985718
